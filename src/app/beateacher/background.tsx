  ...
  return (
    <>
      ...
      <Image
        ...
        className="absolute left-0 top-[200px] z-[-1] select-none bg-cover"
      />
      <Image
        src={Circles}
        alt="Circles background"
        className="absolute bottom-[-680px] right-[0px] z-[-1] select-none bg-cover md:bottom-[-300px] lg:bottom-[-470px] lg:right-[250px]"
      />
    </>
  );
}
